...
// all in one struct, i think there is no need to create three struct
//struct Light {
//	// directional, point
//	vec3 position;
//	vec3 direction;
...
void main()
{
	FragColor = texture(texture_diffuse1, TexCoord);//*vec4(ourColor,1.0);
	// 80% first one and 20% second one
